...
public interface ReservationService {
     ...
     * @param arg0
     * @return
     *     returns javax.xml.ws.Response<async.client.ReserveCarsResponse>
     */
    @WebMethod(operationName = "ReserveCars")
    @RequestWrapper(localName = "ReserveCars", targetNamespace = "http://asu.dgtu.donetsk.ua/ex/students", className = "async.client.ReserveCars")
    @ResponseWrapper(localName = "ReserveCarsResponse", targetNamespace = "http://asu.dgtu.donetsk.ua/ex/students", className = "async.client.ReserveCarsResponse")
